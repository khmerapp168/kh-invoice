...
export const COLORS = {
  ...
  account: '#E0A93E',
  accountTint: '#FBF1E0',
  // NOTE: COLORS.gold above is actually blue (kept as-is since ~50 places
  // already depend on it for consistent secondary-navy accents). This is
  // a genuine warm gold, for spots that want real gold/premium contrast
  // (e.g. the install screen hero, crowns, "best value" highlights).
  accentGold: '#F2B84B',
  accentGoldDark: '#C98F1F',
} as const;
